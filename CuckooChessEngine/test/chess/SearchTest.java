...
public class SearchTest {
    ...
    public void testNegaScout() throws ChessParseError, StopSearch {
        ...
        int score = sc.negaScout(-mate0, mate0, 0, 2, -1);
        ...
        sc = new Search(pos, nullHist, tt);
        score = sc.negaScout(-mate0, mate0, 0, 4, -1);
        ...
        sc = new Search(pos, nullHist, tt);
        score = sc.negaScout(-mate0, mate0, 0, 5, -1);
    ...
    public void testDrawRep() throws ChessParseError, StopSearch {
        ...
        Search sc = new Search(pos, nullHist, tt);
        sc.maxTimeMillis = -1;
        int score = sc.negaScout(-mate0, mate0, 0, 3, -1);
        assertEquals(0, score);
    ...
    public void testScoreMoveList() throws ChessParseError {
        ...
        moves = moveGen.pseudoLegalMoves(pos);
        boolean res = sc.selectHashMove(moves, m);
